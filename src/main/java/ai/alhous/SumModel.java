...
public class SumModel {
    ...
    // The range of the sample data, data in range (0-1 is sensitive for NN, you can
    // try other ranges and see how it effects the results
    ...
    public static void main(String[] args) {
        ...
        MultiLayerNetwork net = new MultiLayerNetwork(new NeuralNetConfiguration.Builder()
                ...
                .layer(0, new DenseLayer.Builder().nIn(numInput).nOut(nHidden)
                        .activation(Activation.TANH) // Change this to RELU and you will see the net learns very well
                                                     // very quickly
                        .build())
